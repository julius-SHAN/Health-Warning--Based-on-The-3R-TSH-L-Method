...
%         sig=mapminmax(sig,0,1);
    ...
    path='..\model\RF\';
    filename1=[path,'M_mitdb2_wt_fir_3R_sta2_t2_harm_stft90_T',num2str(ntree),...
        '_L',num2str(nleaf),'_',num2str(n),'.mat'];
    save(filename1,'model','Conmat','testtime','ACC')
    filename2=[path,'M_mitdb2_wt_fir_3R_sta2_t2_harm_stft90_T',num2str(ntree),...
