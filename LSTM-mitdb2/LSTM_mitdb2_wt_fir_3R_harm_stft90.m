...
%         sig=mapminmax(sig,0,1);
    ...
    path='..\model\LSTM\';
    filename1=[path,'M_mitdb2_wt_fir_3R_harm_stft90_',num2str(numHiddenUnits1),...
        '_',num2str(numHiddenUnits2),'_',num2str(maxEpochs),'_',num2str(miniBatchSize),...
        '_',num2str(n),'.mat'];
    save(filename1,'net','Conmat','testtime','ACC')
    filename2=[path,'M_mitdb2_wt_fir_3R_harm_stft90_',num2str(numHiddenUnits1),...
        '_',num2str(numHiddenUnits2),'_',num2str(maxEpochs),'_',num2str(miniBatchSize),...
        '_',num2str(n),'.png'];
    frame=getframe(gcf);
    im=frame2im(frame);
