...
for n=1:4
    ...
    matname=[matpath,'M_GS_mitdb2_wt_fir_3R_sta2_t2_sb16_harm_stft90_params_acc','.mat'];
    load(matname);
    fprintf('Finished!\n');
    fprintf('=============================================================\n');
    if n==1
...
%         sig=mapminmax(sig,0,1);
    ...
    path='..\model\SVM\';
    filename1=[path,'M_mitdb2_wt_fir_3R_sta2_t2_sb16_harm_stft90-c',...
        num2str(c),'-g',num2str(g),'_',num2str(n),'.mat'];
    save(filename1,'model','Conmat','testtime','ACC')
    filename2=[path,'M_mitdb2_wt_fir_3R_sta2_t2_sb16_harm_stft90-c',...
