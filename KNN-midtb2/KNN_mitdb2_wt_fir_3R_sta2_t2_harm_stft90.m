...
%     model = fitcknn(trainfeat,Labeltrain,'NumNeighbors',10,'Distance','cosine');
    ...
    path='..\model\KNN\';
    filename1=[path,'M_mitdb2_wt_fir_3R_sta2_t2_harm_stft90_K',num2str(k),...
        '_D',d,'_',num2str(n),'.mat'];
    save(filename1,'model','Conmat','testtime','ACC')
    filename2=[path,'M_mitdb2_wt_fir_3R_sta2_t2_harm_stft90_K',num2str(k),...
