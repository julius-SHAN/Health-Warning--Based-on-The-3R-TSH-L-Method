...
st=tic;
filename='.\TR_TE\tr_te_3r_rr_label_blind.mat';
load(filename);
%% 特征提取
...
path='.\model\LSTM\';
filename1=[path,'M_car11_fir_3R_sta2_t2_sb16_harm_stft90_b_',num2str(numHiddenUnits1),...
    '_',num2str(numHiddenUnits2),'_',num2str(maxEpochs),'_',num2str(miniBatchSize),...
    '.mat'];
save(filename1,'net','Conmat','testtime','ACC')
filename2=[path,'M_car11_fir_3R_sta2_t2_sb16_harm_stft90_b_',num2str(numHiddenUnits1),...
    '_',num2str(numHiddenUnits2),'_',num2str(maxEpochs),'_',num2str(miniBatchSize),...
    '.png'];
frame=getframe(gcf);
im=frame2im(frame);
